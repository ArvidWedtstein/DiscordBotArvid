...
module.exports = (client) => {
    client.on('guildMemberAdd', async (member) => {
        ...
        if (setting == false) {
            ...
            let text = `${language(guild, 'WELCOME')}`
            ...
            ctx.font = "25px immortal"
            let text3 = `${language(guild, 'WELCOME_RULES')}`
            x = canvas.width / 2 - ctx.measureText(text3).width / 2
            ctx.fillText(text3, x, 300 + pfp.height)
